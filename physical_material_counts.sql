...
--combine subqueries and include format descriptors from the translation table 'local_core.vs_folio_physical_material_formats'
   SELECT 
    ...
    LEFT JOIN items AS ite ON ite.holdings_record_id = hh.holdings_id 
